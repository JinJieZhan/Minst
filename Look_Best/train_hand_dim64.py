...
model = VisionTransformer(embed_dim=64).to(DEVICE)

# Attempt to load pretrained model
try:
    model.load_state_dict(torch.load('Torch_flagTrue_CLSisUsedFalse_PostionisUsedTrue_dim64.pth', map_location=DEVICE))
...
try:
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(model.state_dict(), 'Torch_flagTrue_CLSisUsedFalse_PostionisUsedTrue_dim64.pth')
...
# Test Loss: 0.129269, Accuracy:  0.960700